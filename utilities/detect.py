...
from yolotf2.dataset import transform_images, load_tfrecord_dataset
from yolotf2.utils import draw_outputs

flags.DEFINE_string('classes', 'labels/coco.names', 'path to classes file')
flags.DEFINE_string('weights', 'YoloWeights/checkpoint/yolov3.tf',
                    'path to weights file')
flags.DEFINE_boolean('tiny', False, 'yolov3 or yolov3-tiny')
flags.DEFINE_integer('size', 416, 'resize images to')
flags.DEFINE_list('images', '', 'list with paths to input images')
